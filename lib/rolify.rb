...
#    return self.superclass.adapter unless self.instance_variable_defined? '@adapter'
    return self.superclass.rdl_cast("Class<ActiveRecord::Base>").adapter unless self.instance_variable_defined? '@adapter'
    @adapter
  end
...
#    return self.superclass.role_class unless self.instance_variable_defined? '@role_cname'
    return self.superclass.rdl_cast("Class<ActiveRecord::Base>").role_class unless self.instance_variable_defined? '@role_cname'
...
require "#{cwd}/../typesigs/rolify_typesigs.rb"
